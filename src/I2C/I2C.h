...
//#define MAX_BUFFER_SIZE 32 // R: same trouble as in other branches ( I really hope I'm not making your job harder by putting stuff here & there .. )
#define MAX_BUFFER_SIZE 128 // nb: thanks for the support of 32u4: I'm about to test that :)
